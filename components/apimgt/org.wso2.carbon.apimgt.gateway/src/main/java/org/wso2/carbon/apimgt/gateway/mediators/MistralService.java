...
public class MistralService {
    ...
    private static final String MISTRAL_API_URL = "";
    private static final String MISTRAL_API_KEY = ""; 
    private static final String MISTRAL_MODEL = "";

    public String classifyRequest(String prompt) {
        try {
            HttpClient httpClient = createHttpClient();
            HttpPost httpPost = createHttpRequest(prompt);
    ...
    private HttpPost createHttpRequest(String prompt) {
        ...
        httpPost.setEntity(new StringEntity(buildRequestPayload(prompt), StandardCharsets.UTF_8));
        return httpPost;
    }
    ...
    private HttpPost createHealthCheckRequest() {
        ...
        httpPost.setHeader("Authorization", "Bearer " + MISTRAL_API_KEY);
        httpPost.setHeader("Content-Type", "application/json");
        httpPost.setEntity(new StringEntity(buildHealthCheckPayload(), StandardCharsets.UTF_8));
        return httpPost;
    }
